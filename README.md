...
pixi add cuda-bindings cuda-python
# for installing globally
pixi global install cuda-bindings cuda-python
```
...
It is possible to list all of the versions of `cuda-bindings` available on your platform:
...
```
pixi search cuda-bindings --channel conda-forge
```
...
* [@Andy-Jost](https://github.com/Andy-Jost/)
